...
RCT_EXPORT_METHOD(getDailyActiveEnergyBurnedSamples:(NSDictionary *)input callback:(RCTResponseSenderBlock)callback)
{
    [self fitness_getDailyActiveEnergyBurnedSamples:input callback:callback];
}

RCT_EXPORT_METHOD(getDailyAppleExerciseTimeSamples:(NSDictionary *)input callback:(RCTResponseSenderBlock)callback)
{
    [self fitness_getDailyAppleExerciseTimeSamples:input callback:callback];
}
